...
Add a new exemple text on exsiting lable And Show items and lables items are increased
    ...
    #Sleep  5s
    Wait Until Page Contains Element   ${TRAINNING_XBUTTON_1}
    Sleep  5s
    Click Element   ${TRAINNING_XBUTTON_1}
    Wait Until Page Contains    Total items
    Sleep  10s
    ${total items_before}  Get Text   ${TOTOAL_ITEMS_BEFORE}
    ...
    ${labeled items_before}   Get Text   ${LABELED_ITEMS_BEFORE}
    ...
    Wait Until Page Contains Element   ${LABLENAME_ACCOUNT}
    Sleep  1s
    ...
    Wait Until Page Contains Element    ${LABLESETTINGS_XBUTTON}
    ...
    Sleep   10s
    Wait Until Page Contains Element   ${TRAINNING_XBUTTON_2}
    Sleep   10s
    Click Element  ${TRAINNING_XBUTTON_2}
    Sleep  10s
    Wait Until Page Contains    Total items
    Sleep  2s
    Wait Until Page Contains Element    ${TOTAL_ITEMS_AFTER}
    #//*[@id="app"]/div[9]/div[1]/main/div/div/div[2]/div/div[1]/div/div[2]/div/div/p[2]
    #Sleep  10s
    ${total items_after}  Get Text     ${TOTAL_ITEMS_AFTER}
    ...
    #Sleep  10s
    #//*[@id="app"]/div[9]/div[1]/main/div/div/div[2]/div/div[1]/div/div[2]/div/div/p[3]
    Wait Until Page Contains Element    ${LABELED_ITEMS_AFTER}
    ${labeled items_after}   Get Text   ${LABELED_ITEMS_AFTER}
...
${TRAINNING_XBUTTON_1}  //*[@id="app"]/div[3]/div/div/button/div/i
${TOTOAL_ITEMS_BEFORE}  //*[@id="app"]/div[9]/div[1]/main/div/div/div[2]/div/div[1]/div/div[2]/div/div/p[3]
${LABELED_ITEMS_BEFORE}  //*[@id="app"]/div[9]/div[1]/main/div/div/div[2]/div/div[1]/div/div[2]/div/div/p[4]
${SETTINGS}             //*[@id="app"]/div[9]/div[1]/main/div/div/div[1]/div/div/div/div/nav/div/a[1]/div/i
${TRAINNING_XBUTTON_2}  //*[@id="app"]/div[2]/div/div/button/div/i
${OVERVIEWBUTTON_2}      //*[@id="app"]/div[4]/div[1]/main/div/div/div[1]/div/div/div/div/nav/div/a[3]/div/i
${TOTAL_ITEMS_AFTER}    //*[@id="app"]/div[9]/div[1]/main/div/div/div[2]/div/div[1]/div/div[2]/div/div/p[3]
${LABELED_ITEMS_AFTER}  //*[@id="app"]/div[9]/div[1]/main/div/div/div[2]/div/div[1]/div/div[2]/div/div/p[4]
