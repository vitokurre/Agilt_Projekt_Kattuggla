...
Processing Indicators Shall Appear
    Wait Until Page Contains Element  ${ADDEXEMPLES_TEXTFIELD}
    Sleep  3s
    Input Text  ${ADDEXEMPLES_TEXTFIELD}   How much is the cancellation fee?
    Sleep  3s
    Wait Until Page Contains Element  ${UPPDATELABEL_BUTTON}
    Sleep  1s
    Click Element  ${UPPDATELABEL_BUTTON}
    Sleep  1s
    Wait Until Page Contains Element  ${OVERVIEW_BUTTON}
    Sleep  1s
    Click Element  ${OVERVIEW_BUTTON}
    Sleep  1s
    Wait Until Page Contains Element  ${TRAINING_XBUTTON2}
    Sleep  2s
    Click Element  ${TRAINING_XBUTTON2}
    Sleep  5s
    Wait Until Page Contains Element  ${PROCESSING_BUTTON}
